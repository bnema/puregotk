...
func InterpTypeGLibType() types.GType {
	core.LazyRegister(&xInterpTypeGLibType, "GDKPIXBUF", "gdk_interp_type_get_type", false)
...
func PixbufRotationGLibType() types.GType {
	core.LazyRegister(&xPixbufRotationGLibType, "GDKPIXBUF", "gdk_pixbuf_rotation_get_type", false)
