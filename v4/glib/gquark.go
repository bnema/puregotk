...
func InternStaticString(StringVar *string) string {
	core.LazyRegister(&xInternStaticString, "GLIB", "g_intern_static_string", false)
...
func InternString(StringVar *string) string {
	core.LazyRegister(&xInternString, "GLIB", "g_intern_string", false)
...
func QuarkFromStaticString(StringVar *string) Quark {
	core.LazyRegister(&xQuarkFromStaticString, "GLIB", "g_quark_from_static_string", false)
...
func QuarkFromString(StringVar *string) Quark {
	core.LazyRegister(&xQuarkFromString, "GLIB", "g_quark_from_string", false)
...
func QuarkToString(QuarkVar Quark) string {
	core.LazyRegister(&xQuarkToString, "GLIB", "g_quark_to_string", false)
...
func QuarkTryString(StringVar *string) Quark {
	core.LazyRegister(&xQuarkTryString, "GLIB", "g_quark_try_string", false)
