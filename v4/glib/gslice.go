...
func SliceAlloc(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xSliceAlloc, "GLIB", "g_slice_alloc", false)
...
func SliceAlloc0(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xSliceAlloc0, "GLIB", "g_slice_alloc0", false)
...
func SliceCopy(BlockSizeVar uint, MemBlockVar uintptr) uintptr {
	core.LazyRegister(&xSliceCopy, "GLIB", "g_slice_copy", false)
...
func SliceFree1(BlockSizeVar uint, MemBlockVar uintptr) {
	core.LazyRegister(&xSliceFree1, "GLIB", "g_slice_free1", false)
...
func SliceFreeChainWithOffset(BlockSizeVar uint, MemChainVar uintptr, NextOffsetVar uint) {
	core.LazyRegister(&xSliceFreeChainWithOffset, "GLIB", "g_slice_free_chain_with_offset", false)
...
func SliceGetConfig(CkeyVar SliceConfig) int64 {
	core.LazyRegister(&xSliceGetConfig, "GLIB", "g_slice_get_config", false)
...
func SliceGetConfigState(CkeyVar SliceConfig, AddressVar int64, NValuesVar uint) int64 {
	core.LazyRegister(&xSliceGetConfigState, "GLIB", "g_slice_get_config_state", false)
...
func SliceSetConfig(CkeyVar SliceConfig, ValueVar int64) {
	core.LazyRegister(&xSliceSetConfig, "GLIB", "g_slice_set_config", false)
