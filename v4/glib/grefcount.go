...
func AtomicRefCountCompare(ArcVar int, ValVar int) bool {
	core.LazyRegister(&xAtomicRefCountCompare, "GLIB", "g_atomic_ref_count_compare", false)
...
func AtomicRefCountDec(ArcVar int) bool {
	core.LazyRegister(&xAtomicRefCountDec, "GLIB", "g_atomic_ref_count_dec", false)
...
func AtomicRefCountInc(ArcVar int) {
	core.LazyRegister(&xAtomicRefCountInc, "GLIB", "g_atomic_ref_count_inc", false)
...
func AtomicRefCountInit(ArcVar *int) {
	core.LazyRegister(&xAtomicRefCountInit, "GLIB", "g_atomic_ref_count_init", false)
...
func RefCountCompare(RcVar int, ValVar int) bool {
	core.LazyRegister(&xRefCountCompare, "GLIB", "g_ref_count_compare", false)
...
func RefCountDec(RcVar *int) bool {
	core.LazyRegister(&xRefCountDec, "GLIB", "g_ref_count_dec", false)
...
func RefCountInc(RcVar *int) {
	core.LazyRegister(&xRefCountInc, "GLIB", "g_ref_count_inc", false)
...
func RefCountInit(RcVar *int) {
	core.LazyRegister(&xRefCountInit, "GLIB", "g_ref_count_init", false)
