...
func Basename(FileNameVar string) string {
	core.LazyRegister(&xBasename, "GLIB", "g_basename", false)
...
func BuildFilename(FirstElementVar string, varArgs ...interface{}) string {
	core.LazyRegister(&xBuildFilename, "GLIB", "g_build_filename", false)
...
func BuildFilenameValist(FirstElementVar string, ArgsVar []interface{}) string {
	core.LazyRegister(&xBuildFilenameValist, "GLIB", "g_build_filename_valist", false)
...
func BuildFilenamev(ArgsVar []string) string {
	core.LazyRegister(&xBuildFilenamev, "GLIB", "g_build_filenamev", false)
...
func BuildPath(SeparatorVar string, FirstElementVar string, varArgs ...interface{}) string {
	core.LazyRegister(&xBuildPath, "GLIB", "g_build_path", false)
...
func BuildPathv(SeparatorVar string, ArgsVar []string) string {
	core.LazyRegister(&xBuildPathv, "GLIB", "g_build_pathv", false)
...
func CanonicalizeFilename(FilenameVar string, RelativeToVar *string) string {
	core.LazyRegister(&xCanonicalizeFilename, "GLIB", "g_canonicalize_filename", false)

	RelativeToVarPtr := core.GStrdupNullable(RelativeToVar)
	defer core.GFreeNullable(RelativeToVarPtr)
...
func DirMakeTmp(TmplVar *string) (string, error) {
	core.LazyRegister(&xDirMakeTmp, "GLIB", "g_dir_make_tmp", false)
	var cerr *Error
...
func FileErrorFromErrno(ErrNoVar int) FileError {
	core.LazyRegister(&xFileErrorFromErrno, "GLIB", "g_file_error_from_errno", false)
...
func FileGetContents(FilenameVar string, ContentsVar *[]byte, LengthVar *uint) (bool, error) {
	core.LazyRegister(&xFileGetContents, "GLIB", "g_file_get_contents", false)
	var cerr *Error
...
func FileOpenTmp(TmplVar *string, NameUsedVar *string) (int, error) {
	core.LazyRegister(&xFileOpenTmp, "GLIB", "g_file_open_tmp", false)
	var cerr *Error
...
func FileReadLink(FilenameVar string) (string, error) {
	core.LazyRegister(&xFileReadLink, "GLIB", "g_file_read_link", false)
	var cerr *Error
...
func FileSetContents(FilenameVar string, ContentsVar []byte, LengthVar int) (bool, error) {
	core.LazyRegister(&xFileSetContents, "GLIB", "g_file_set_contents", false)
	var cerr *Error
...
func FileSetContentsFull(FilenameVar string, ContentsVar []byte, LengthVar int, FlagsVar FileSetContentsFlags, ModeVar int) (bool, error) {
	core.LazyRegister(&xFileSetContentsFull, "GLIB", "g_file_set_contents_full", false)
	var cerr *Error
...
func NewFileTest(FilenameVar string, TestVar FileTest) bool {
	core.LazyRegister(&xNewFileTest, "GLIB", "g_file_test", false)
...
func GetCurrentDir() string {
	core.LazyRegister(&xGetCurrentDir, "GLIB", "g_get_current_dir", false)
...
func MkdirWithParents(PathnameVar string, ModeVar int) int {
	core.LazyRegister(&xMkdirWithParents, "GLIB", "g_mkdir_with_parents", false)
...
func Mkdtemp(TmplVar string) string {
	core.LazyRegister(&xMkdtemp, "GLIB", "g_mkdtemp", false)
...
func MkdtempFull(TmplVar string, ModeVar int) string {
	core.LazyRegister(&xMkdtempFull, "GLIB", "g_mkdtemp_full", false)
...
func Mkstemp(TmplVar string) int {
	core.LazyRegister(&xMkstemp, "GLIB", "g_mkstemp", false)
...
func MkstempFull(TmplVar string, FlagsVar int, ModeVar int) int {
	core.LazyRegister(&xMkstempFull, "GLIB", "g_mkstemp_full", false)
...
func PathGetBasename(FileNameVar string) string {
	core.LazyRegister(&xPathGetBasename, "GLIB", "g_path_get_basename", false)
...
func PathGetDirname(FileNameVar string) string {
	core.LazyRegister(&xPathGetDirname, "GLIB", "g_path_get_dirname", false)
...
func PathIsAbsolute(FileNameVar string) bool {
	core.LazyRegister(&xPathIsAbsolute, "GLIB", "g_path_is_absolute", false)
...
func PathSkipRoot(FileNameVar string) string {
	core.LazyRegister(&xPathSkipRoot, "GLIB", "g_path_skip_root", false)
