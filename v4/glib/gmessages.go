...
func init() {
	...
	core.PuregoSafeRegister(&xLogWriterDefaultSetDebugDomains, lib, "g_log_writer_default_set_debug_domains")
	...
	core.PuregoSafeRegister(&xLogWriterSyslog, lib, "g_log_writer_syslog")
