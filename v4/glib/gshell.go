...
func ShellParseArgv(CommandLineVar string, ArgcpVar *int, ArgvpVar *[]string) (bool, error) {
	core.LazyRegister(&xShellParseArgv, "GLIB", "g_shell_parse_argv", false)
	var cerr *Error
...
func ShellQuote(UnquotedStringVar string) string {
	core.LazyRegister(&xShellQuote, "GLIB", "g_shell_quote", false)
...
func ShellUnquote(QuotedStringVar string) (string, error) {
	core.LazyRegister(&xShellUnquote, "GLIB", "g_shell_unquote", false)
	var cerr *Error
