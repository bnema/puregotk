...
func AsciiDigitValue(CVar byte) int {
	core.LazyRegister(&xAsciiDigitValue, "GLIB", "g_ascii_digit_value", false)
...
func AsciiDtostr(BufferVar string, BufLenVar int, DVar float64) string {
	core.LazyRegister(&xAsciiDtostr, "GLIB", "g_ascii_dtostr", false)
...
func AsciiFormatd(BufferVar string, BufLenVar int, FormatVar string, DVar float64) string {
	core.LazyRegister(&xAsciiFormatd, "GLIB", "g_ascii_formatd", false)
...
func AsciiStrcasecmp(S1Var string, S2Var string) int {
	core.LazyRegister(&xAsciiStrcasecmp, "GLIB", "g_ascii_strcasecmp", false)
...
func AsciiStrdown(StrVar string, LenVar int) string {
	core.LazyRegister(&xAsciiStrdown, "GLIB", "g_ascii_strdown", false)
...
func AsciiStringToSigned(StrVar string, BaseVar uint, MinVar int64, MaxVar int64, OutNumVar *int64) (bool, error) {
	core.LazyRegister(&xAsciiStringToSigned, "GLIB", "g_ascii_string_to_signed", false)
	var cerr *Error
...
func AsciiStringToUnsigned(StrVar string, BaseVar uint, MinVar uint64, MaxVar uint64, OutNumVar *uint64) (bool, error) {
	core.LazyRegister(&xAsciiStringToUnsigned, "GLIB", "g_ascii_string_to_unsigned", false)
	var cerr *Error
...
func AsciiStrncasecmp(S1Var string, S2Var string, NVar uint) int {
	core.LazyRegister(&xAsciiStrncasecmp, "GLIB", "g_ascii_strncasecmp", false)
...
func AsciiStrtod(NptrVar string, EndptrVar *string) float64 {
	core.LazyRegister(&xAsciiStrtod, "GLIB", "g_ascii_strtod", false)
...
func AsciiStrtoll(NptrVar string, EndptrVar *string, BaseVar uint) int64 {
	core.LazyRegister(&xAsciiStrtoll, "GLIB", "g_ascii_strtoll", false)
...
func AsciiStrtoull(NptrVar string, EndptrVar *string, BaseVar uint) uint64 {
	core.LazyRegister(&xAsciiStrtoull, "GLIB", "g_ascii_strtoull", false)
...
func AsciiStrup(StrVar string, LenVar int) string {
	core.LazyRegister(&xAsciiStrup, "GLIB", "g_ascii_strup", false)
...
func AsciiTolower(CVar byte) byte {
	core.LazyRegister(&xAsciiTolower, "GLIB", "g_ascii_tolower", false)
...
func AsciiToupper(CVar byte) byte {
	core.LazyRegister(&xAsciiToupper, "GLIB", "g_ascii_toupper", false)
...
func AsciiXdigitValue(CVar byte) int {
	core.LazyRegister(&xAsciiXdigitValue, "GLIB", "g_ascii_xdigit_value", false)
...
func Memdup(MemVar uintptr, ByteSizeVar uint) uintptr {
	core.LazyRegister(&xMemdup, "GLIB", "g_memdup", false)
...
func Memdup2(MemVar uintptr, ByteSizeVar uint) uintptr {
	core.LazyRegister(&xMemdup2, "GLIB", "g_memdup2", false)
...
func Stpcpy(DestVar string, SrcVar string) string {
	core.LazyRegister(&xStpcpy, "GLIB", "g_stpcpy", false)
...
func StrHasPrefix(StrVar string, PrefixVar string) bool {
	core.LazyRegister(&xStrHasPrefix, "GLIB", "g_str_has_prefix", false)
...
func StrHasSuffix(StrVar string, SuffixVar string) bool {
	core.LazyRegister(&xStrHasSuffix, "GLIB", "g_str_has_suffix", false)
...
func StrIsAscii(StrVar string) bool {
	core.LazyRegister(&xStrIsAscii, "GLIB", "g_str_is_ascii", false)
...
func StrMatchString(SearchTermVar string, PotentialHitVar string, AcceptAlternatesVar bool) bool {
	core.LazyRegister(&xStrMatchString, "GLIB", "g_str_match_string", false)
...
func StrToAscii(StrVar string, FromLocaleVar *string) string {
	core.LazyRegister(&xStrToAscii, "GLIB", "g_str_to_ascii", false)
...
func StrTokenizeAndFold(StringVar string, TranslitLocaleVar *string, AsciiAlternatesVar *[]string) []string {
	core.LazyRegister(&xStrTokenizeAndFold, "GLIB", "g_str_tokenize_and_fold", false)
...
func Strcanon(StringVar string, ValidCharsVar string, SubstitutorVar byte) string {
	core.LazyRegister(&xStrcanon, "GLIB", "g_strcanon", false)
...
func Strcasecmp(S1Var string, S2Var string) int {
	core.LazyRegister(&xStrcasecmp, "GLIB", "g_strcasecmp", false)
...
func Strchomp(StringVar string) string {
	core.LazyRegister(&xStrchomp, "GLIB", "g_strchomp", false)
...
func Strchug(StringVar string) string {
	core.LazyRegister(&xStrchug, "GLIB", "g_strchug", false)
...
func Strcompress(SourceVar string) string {
	core.LazyRegister(&xStrcompress, "GLIB", "g_strcompress", false)
...
func Strconcat(String1Var string, varArgs ...interface{}) string {
	core.LazyRegister(&xStrconcat, "GLIB", "g_strconcat", false)
...
func Strdelimit(StringVar string, DelimitersVar *string, NewDelimiterVar byte) string {
	core.LazyRegister(&xStrdelimit, "GLIB", "g_strdelimit", false)
...
func Strdown(StringVar string) string {
	core.LazyRegister(&xStrdown, "GLIB", "g_strdown", false)
...
func Strdup(StrVar *string) string {
	core.LazyRegister(&xStrdup, "GLIB", "g_strdup", false)
...
func StrdupPrintf(FormatVar string, varArgs ...interface{}) string {
	core.LazyRegister(&xStrdupPrintf, "GLIB", "g_strdup_printf", false)
...
func StrdupVprintf(FormatVar string, ArgsVar []interface{}) string {
	core.LazyRegister(&xStrdupVprintf, "GLIB", "g_strdup_vprintf", false)
...
func Strdupv(StrArrayVar []string) []string {
	core.LazyRegister(&xStrdupv, "GLIB", "g_strdupv", false)
...
func Strerror(ErrnumVar int) string {
	core.LazyRegister(&xStrerror, "GLIB", "g_strerror", false)
...
func Strescape(SourceVar string, ExceptionsVar *string) string {
	core.LazyRegister(&xStrescape, "GLIB", "g_strescape", false)
...
func Strfreev(StrArrayVar []string) {
	core.LazyRegister(&xStrfreev, "GLIB", "g_strfreev", false)
...
func Strjoin(SeparatorVar *string, varArgs ...interface{}) string {
	core.LazyRegister(&xStrjoin, "GLIB", "g_strjoin", false)
...
func Strjoinv(SeparatorVar *string, StrArrayVar []string) string {
	core.LazyRegister(&xStrjoinv, "GLIB", "g_strjoinv", false)
...
func Strlcat(DestVar string, SrcVar string, DestSizeVar uint) uint {
	core.LazyRegister(&xStrlcat, "GLIB", "g_strlcat", false)
...
func Strlcpy(DestVar string, SrcVar string, DestSizeVar uint) uint {
	core.LazyRegister(&xStrlcpy, "GLIB", "g_strlcpy", false)
...
func Strncasecmp(S1Var string, S2Var string, NVar uint) int {
	core.LazyRegister(&xStrncasecmp, "GLIB", "g_strncasecmp", false)
...
func Strndup(StrVar *string, NVar uint) string {
	core.LazyRegister(&xStrndup, "GLIB", "g_strndup", false)
...
func Strnfill(LengthVar uint, FillCharVar byte) string {
	core.LazyRegister(&xStrnfill, "GLIB", "g_strnfill", false)
...
func Strreverse(StringVar string) string {
	core.LazyRegister(&xStrreverse, "GLIB", "g_strreverse", false)
...
func Strrstr(HaystackVar string, NeedleVar string) string {
	core.LazyRegister(&xStrrstr, "GLIB", "g_strrstr", false)
...
func StrrstrLen(HaystackVar string, HaystackLenVar int, NeedleVar string) string {
	core.LazyRegister(&xStrrstrLen, "GLIB", "g_strrstr_len", false)
...
func Strsignal(SignumVar int) string {
	core.LazyRegister(&xStrsignal, "GLIB", "g_strsignal", false)
...
func Strsplit(StringVar string, DelimiterVar string, MaxTokensVar int) []string {
	core.LazyRegister(&xStrsplit, "GLIB", "g_strsplit", false)

	cret := xStrsplit(StringVar, DelimiterVar, MaxTokensVar)
	return cret
}

var xStrsplitSet func(string, []byte, int) []string
...
func StrsplitSet(StringVar string, DelimitersVar []byte, MaxTokensVar int) []string {
	core.LazyRegister(&xStrsplitSet, "GLIB", "g_strsplit_set", false)
...
func StrstrLen(HaystackVar string, HaystackLenVar int, NeedleVar string) string {
	core.LazyRegister(&xStrstrLen, "GLIB", "g_strstr_len", false)
...
func Strtod(NptrVar string, EndptrVar *string) float64 {
	core.LazyRegister(&xStrtod, "GLIB", "g_strtod", false)
...
func Strup(StringVar string) string {
	core.LazyRegister(&xStrup, "GLIB", "g_strup", false)
...
func StrvContains(StrvVar []string, StrVar string) bool {
	core.LazyRegister(&xStrvContains, "GLIB", "g_strv_contains", false)
...
func StrvEqual(Strv1Var []string, Strv2Var []string) bool {
	core.LazyRegister(&xStrvEqual, "GLIB", "g_strv_equal", false)
...
func StrvLength(StrArrayVar []string) uint {
	core.LazyRegister(&xStrvLength, "GLIB", "g_strv_length", false)
