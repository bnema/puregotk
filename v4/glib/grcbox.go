...
func AtomicRcBoxAcquire(MemBlockVar uintptr) uintptr {
	core.LazyRegister(&xAtomicRcBoxAcquire, "GLIB", "g_atomic_rc_box_acquire", false)
...
func AtomicRcBoxAlloc(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xAtomicRcBoxAlloc, "GLIB", "g_atomic_rc_box_alloc", false)
...
func AtomicRcBoxAlloc0(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xAtomicRcBoxAlloc0, "GLIB", "g_atomic_rc_box_alloc0", false)
...
func AtomicRcBoxDup(BlockSizeVar uint, MemBlockVar uintptr) uintptr {
	core.LazyRegister(&xAtomicRcBoxDup, "GLIB", "g_atomic_rc_box_dup", false)
...
func AtomicRcBoxGetSize(MemBlockVar uintptr) uint {
	core.LazyRegister(&xAtomicRcBoxGetSize, "GLIB", "g_atomic_rc_box_get_size", false)
...
func AtomicRcBoxRelease(MemBlockVar uintptr) {
	core.LazyRegister(&xAtomicRcBoxRelease, "GLIB", "g_atomic_rc_box_release", false)
...
func AtomicRcBoxReleaseFull(MemBlockVar uintptr, ClearFuncVar *DestroyNotify) {
	core.LazyRegister(&xAtomicRcBoxReleaseFull, "GLIB", "g_atomic_rc_box_release_full", false)
...
func RcBoxAcquire(MemBlockVar uintptr) uintptr {
	core.LazyRegister(&xRcBoxAcquire, "GLIB", "g_rc_box_acquire", false)
...
func RcBoxAlloc(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xRcBoxAlloc, "GLIB", "g_rc_box_alloc", false)
...
func RcBoxAlloc0(BlockSizeVar uint) uintptr {
	core.LazyRegister(&xRcBoxAlloc0, "GLIB", "g_rc_box_alloc0", false)
...
func RcBoxDup(BlockSizeVar uint, MemBlockVar uintptr) uintptr {
	core.LazyRegister(&xRcBoxDup, "GLIB", "g_rc_box_dup", false)
...
func RcBoxGetSize(MemBlockVar uintptr) uint {
	core.LazyRegister(&xRcBoxGetSize, "GLIB", "g_rc_box_get_size", false)
...
func RcBoxRelease(MemBlockVar uintptr) {
	core.LazyRegister(&xRcBoxRelease, "GLIB", "g_rc_box_release", false)
...
func RcBoxReleaseFull(MemBlockVar uintptr, ClearFuncVar *DestroyNotify) {
	core.LazyRegister(&xRcBoxReleaseFull, "GLIB", "g_rc_box_release_full", false)
