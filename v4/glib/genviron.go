...
func EnvironGetenv(EnvpVar []string, VariableVar string) string {
	core.LazyRegister(&xEnvironGetenv, "GLIB", "g_environ_getenv", false)
...
func EnvironSetenv(EnvpVar []string, VariableVar string, ValueVar string, OverwriteVar bool) []string {
	core.LazyRegister(&xEnvironSetenv, "GLIB", "g_environ_setenv", false)
...
func EnvironUnsetenv(EnvpVar []string, VariableVar string) []string {
	core.LazyRegister(&xEnvironUnsetenv, "GLIB", "g_environ_unsetenv", false)
...
func GetEnviron() []string {
	core.LazyRegister(&xGetEnviron, "GLIB", "g_get_environ", false)
...
func Getenv(VariableVar string) string {
	core.LazyRegister(&xGetenv, "GLIB", "g_getenv", false)
...
func Listenv() []string {
	core.LazyRegister(&xListenv, "GLIB", "g_listenv", false)
...
func Setenv(VariableVar string, ValueVar string, OverwriteVar bool) bool {
	core.LazyRegister(&xSetenv, "GLIB", "g_setenv", false)
...
func Unsetenv(VariableVar string) {
	core.LazyRegister(&xUnsetenv, "GLIB", "g_unsetenv", false)
