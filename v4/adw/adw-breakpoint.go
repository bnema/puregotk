...
func (x *Breakpoint) ConnectApply(cb *func(Breakpoint)) uint {
	...
	cbRefPtr := glib.SharedCallback("adw.Breakpoint.Apply", func(clsPtr uintptr, signalData uintptr) {
...
func (x *Breakpoint) ConnectUnapply(cb *func(Breakpoint)) uint {
	signalData := glib.SaveSignalHandler(cb)
	cbRefPtr := glib.SharedCallback("adw.Breakpoint.Unapply", func(clsPtr uintptr, signalData uintptr) {
		handler, ok := glib.GetSignalHandler(signalData)
		if !ok {
			return
		}
	...
	handlerID := gobject.SignalConnectDataRaw(x.GoPointer(), "unapply", cbRefPtr, signalData, glib.SignalDestroyNotify(), gobject.GConnectDefaultValue)
	glib.SaveSignalHandlerMapping(handlerID, signalData)
	return handlerID
}
