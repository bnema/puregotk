...
func (x *Carousel) ConnectPageChanged(cb *func(Carousel, uint)) uint {
	...
	cbRefPtr := glib.SharedCallback("adw.Carousel.PageChanged", func(clsPtr uintptr, IndexVarp uint, signalData uintptr) {
	...
	handlerID := gobject.SignalConnectDataRaw(x.GoPointer(), "page-changed", cbRefPtr, signalData, glib.SignalDestroyNotify(), gobject.GConnectDefaultValue)
...
func (x *Carousel) GetAccessibleParent() *gtk.AccessibleBase {
...
func (x *Carousel) GetAtContext() *gtk.ATContext {
...
func (x *Carousel) GetFirstAccessibleChild() *gtk.AccessibleBase {
	var cls *gtk.AccessibleBase
...
func (x *Carousel) GetNextAccessibleSibling() *gtk.AccessibleBase {
	var cls *gtk.AccessibleBase
