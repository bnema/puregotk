...
func init() {
	...
	core.PuregoSafeRegister(&xToggleGLibType, lib, "adw_toggle_get_type")

	core.PuregoSafeRegister(&xNewToggle, lib, "adw_toggle_new")

	core.PuregoSafeRegister(&xToggleGetChild, lib, "adw_toggle_get_child")
	core.PuregoSafeRegister(&xToggleGetEnabled, lib, "adw_toggle_get_enabled")
	core.PuregoSafeRegister(&xToggleGetIconName, lib, "adw_toggle_get_icon_name")
	core.PuregoSafeRegister(&xToggleGetIndex, lib, "adw_toggle_get_index")
	core.PuregoSafeRegister(&xToggleGetLabel, lib, "adw_toggle_get_label")
	core.PuregoSafeRegister(&xToggleGetName, lib, "adw_toggle_get_name")
	core.PuregoSafeRegister(&xToggleGetTooltip, lib, "adw_toggle_get_tooltip")
	core.PuregoSafeRegister(&xToggleGetUseUnderline, lib, "adw_toggle_get_use_underline")
	core.PuregoSafeRegister(&xToggleSetChild, lib, "adw_toggle_set_child")
	core.PuregoSafeRegister(&xToggleSetEnabled, lib, "adw_toggle_set_enabled")
	core.PuregoSafeRegister(&xToggleSetIconName, lib, "adw_toggle_set_icon_name")
	core.PuregoSafeRegister(&xToggleSetLabel, lib, "adw_toggle_set_label")
	core.PuregoSafeRegister(&xToggleSetName, lib, "adw_toggle_set_name")
	core.PuregoSafeRegister(&xToggleSetTooltip, lib, "adw_toggle_set_tooltip")
	core.PuregoSafeRegister(&xToggleSetUseUnderline, lib, "adw_toggle_set_use_underline")

	core.PuregoSafeRegister(&xToggleGroupGLibType, lib, "adw_toggle_group_get_type")

	core.PuregoSafeRegister(&xNewToggleGroup, lib, "adw_toggle_group_new")

	core.PuregoSafeRegister(&xToggleGroupAdd, lib, "adw_toggle_group_add")
	core.PuregoSafeRegister(&xToggleGroupGetActive, lib, "adw_toggle_group_get_active")
	core.PuregoSafeRegister(&xToggleGroupGetActiveName, lib, "adw_toggle_group_get_active_name")
	core.PuregoSafeRegister(&xToggleGroupGetCanShrink, lib, "adw_toggle_group_get_can_shrink")
	core.PuregoSafeRegister(&xToggleGroupGetHomogeneous, lib, "adw_toggle_group_get_homogeneous")
	core.PuregoSafeRegister(&xToggleGroupGetNToggles, lib, "adw_toggle_group_get_n_toggles")
	core.PuregoSafeRegister(&xToggleGroupGetToggle, lib, "adw_toggle_group_get_toggle")
	core.PuregoSafeRegister(&xToggleGroupGetToggleByName, lib, "adw_toggle_group_get_toggle_by_name")
	core.PuregoSafeRegister(&xToggleGroupGetToggles, lib, "adw_toggle_group_get_toggles")
	core.PuregoSafeRegister(&xToggleGroupRemove, lib, "adw_toggle_group_remove")
	core.PuregoSafeRegister(&xToggleGroupRemoveAll, lib, "adw_toggle_group_remove_all")
	core.PuregoSafeRegister(&xToggleGroupSetActive, lib, "adw_toggle_group_set_active")
	core.PuregoSafeRegister(&xToggleGroupSetActiveName, lib, "adw_toggle_group_set_active_name")
	core.PuregoSafeRegister(&xToggleGroupSetCanShrink, lib, "adw_toggle_group_set_can_shrink")
	core.PuregoSafeRegister(&xToggleGroupSetHomogeneous, lib, "adw_toggle_group_set_homogeneous")
