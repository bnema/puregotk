...
func IsolationGLibType() types.GType {
	core.LazyRegister(&xIsolationGLibType, "GSK", "gsk_isolation_get_type", false)
...
func BlendModeGLibType() types.GType {
	core.LazyRegister(&xBlendModeGLibType, "GSK", "gsk_blend_mode_get_type", false)
...
func CornerGLibType() types.GType {
	core.LazyRegister(&xCornerGLibType, "GSK", "gsk_corner_get_type", false)
...
func FillRuleGLibType() types.GType {
	core.LazyRegister(&xFillRuleGLibType, "GSK", "gsk_fill_rule_get_type", false)
...
func GLUniformTypeGLibType() types.GType {
	core.LazyRegister(&xGLUniformTypeGLibType, "GSK", "gsk_gl_uniform_type_get_type", false)
...
func LineCapGLibType() types.GType {
	core.LazyRegister(&xLineCapGLibType, "GSK", "gsk_line_cap_get_type", false)
...
func LineJoinGLibType() types.GType {
	core.LazyRegister(&xLineJoinGLibType, "GSK", "gsk_line_join_get_type", false)
...
func MaskModeGLibType() types.GType {
	core.LazyRegister(&xMaskModeGLibType, "GSK", "gsk_mask_mode_get_type", false)
...
func PathDirectionGLibType() types.GType {
	core.LazyRegister(&xPathDirectionGLibType, "GSK", "gsk_path_direction_get_type", false)
...
func PathOperationGLibType() types.GType {
	core.LazyRegister(&xPathOperationGLibType, "GSK", "gsk_path_operation_get_type", false)
...
func PorterDuffGLibType() types.GType {
	core.LazyRegister(&xPorterDuffGLibType, "GSK", "gsk_porter_duff_get_type", false)
...
func RenderNodeTypeGLibType() types.GType {
	core.LazyRegister(&xRenderNodeTypeGLibType, "GSK", "gsk_render_node_type_get_type", false)
...
func ScalingFilterGLibType() types.GType {
	core.LazyRegister(&xScalingFilterGLibType, "GSK", "gsk_scaling_filter_get_type", false)
...
func SerializationErrorGLibType() types.GType {
	core.LazyRegister(&xSerializationErrorGLibType, "GSK", "gsk_serialization_error_get_type", false)
...
func TransformCategoryGLibType() types.GType {
	core.LazyRegister(&xTransformCategoryGLibType, "GSK", "gsk_transform_category_get_type", false)
