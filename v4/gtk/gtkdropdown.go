...
func (x *DropDown) ConnectActivate(cb *func(DropDown)) uint {
	signalData := glib.SaveSignalHandler(cb)
	cbRefPtr := glib.SharedCallback("gtk.DropDown.Activate", func(clsPtr uintptr, signalData uintptr) {
...
func (x *DropDown) GetAccessibleId() string {
