...
//
// ```
func (x *ConstraintLayout) AddConstraintsFromDescriptionv(LinesVar []string, NLinesVar uint, HspacingVar int32, VspacingVar int32, ViewsVar *glib.HashTable) (*glib.List, error) {
	var cerr *glib.Error
