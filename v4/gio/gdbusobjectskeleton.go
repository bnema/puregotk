...
func (x *DBusObjectSkeleton) ConnectAuthorizeMethod(cb *func(DBusObjectSkeleton, uintptr, uintptr) bool) uint {
	...
	cbRefPtr := glib.SharedCallback("gio.DBusObjectSkeleton.AuthorizeMethod", func(clsPtr uintptr, InterfaceVarp uintptr, InvocationVarp uintptr, signalData uintptr) bool {
	...
	handlerID := gobject.SignalConnectDataRaw(x.GoPointer(), "authorize-method", cbRefPtr, signalData, glib.SignalDestroyNotify(), gobject.GConnectDefaultValue)
