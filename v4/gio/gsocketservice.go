...
func (x *SocketService) ConnectIncoming(cb *func(SocketService, uintptr, uintptr) bool) uint {
	...
	cbRefPtr := glib.SharedCallback("gio.SocketService.Incoming", func(clsPtr uintptr, ConnectionVarp uintptr, SourceObjectVarp uintptr, signalData uintptr) bool {
	...
	handlerID := gobject.SignalConnectDataRaw(x.GoPointer(), "incoming", cbRefPtr, signalData, glib.SignalDestroyNotify(), gobject.GConnectDefaultValue)
