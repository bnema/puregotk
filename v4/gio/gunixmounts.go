...
func init() {
	...
	core.PuregoSafeRegister(&xUnixIsMountPathSystemInternal, libs, "g_unix_is_mount_path_system_internal")
	core.PuregoSafeRegister(&xUnixIsSystemDevicePath, libs, "g_unix_is_system_device_path")
	core.PuregoSafeRegister(&xUnixIsSystemFsType, libs, "g_unix_is_system_fs_type")
	core.PuregoSafeRegister(&xUnixMountAt, libs, "g_unix_mount_at")
	core.PuregoSafeRegister(&xUnixMountCompare, libs, "g_unix_mount_compare")
	core.PuregoSafeRegister(&xUnixMountCopy, libs, "g_unix_mount_copy")
	core.PuregoSafeRegister(&xUnixMountEntriesChangedSince, libs, "g_unix_mount_entries_changed_since")
	core.PuregoSafeRegister(&xUnixMountEntriesGet, libs, "g_unix_mount_entries_get")
	core.PuregoSafeRegister(&xUnixMountEntriesGetFromFile, libs, "g_unix_mount_entries_get_from_file")
	core.PuregoSafeRegister(&xUnixMountEntryAt, libs, "g_unix_mount_entry_at")
	core.PuregoSafeRegister(&xUnixMountEntryFor, libs, "g_unix_mount_entry_for")
	core.PuregoSafeRegister(&xUnixMountFor, libs, "g_unix_mount_for")
	core.PuregoSafeRegister(&xUnixMountFree, libs, "g_unix_mount_free")
	core.PuregoSafeRegister(&xUnixMountGetDevicePath, libs, "g_unix_mount_get_device_path")
	core.PuregoSafeRegister(&xUnixMountGetFsType, libs, "g_unix_mount_get_fs_type")
	core.PuregoSafeRegister(&xUnixMountGetMountPath, libs, "g_unix_mount_get_mount_path")
	core.PuregoSafeRegister(&xUnixMountGetOptions, libs, "g_unix_mount_get_options")
	core.PuregoSafeRegister(&xUnixMountGetRootPath, libs, "g_unix_mount_get_root_path")
	core.PuregoSafeRegister(&xUnixMountGuessCanEject, libs, "g_unix_mount_guess_can_eject")
	core.PuregoSafeRegister(&xUnixMountGuessIcon, libs, "g_unix_mount_guess_icon")
	core.PuregoSafeRegister(&xUnixMountGuessName, libs, "g_unix_mount_guess_name")
	core.PuregoSafeRegister(&xUnixMountGuessShouldDisplay, libs, "g_unix_mount_guess_should_display")
	core.PuregoSafeRegister(&xUnixMountGuessSymbolicIcon, libs, "g_unix_mount_guess_symbolic_icon")
	core.PuregoSafeRegister(&xUnixMountIsReadonly, libs, "g_unix_mount_is_readonly")
	core.PuregoSafeRegister(&xUnixMountIsSystemInternal, libs, "g_unix_mount_is_system_internal")
	core.PuregoSafeRegister(&xUnixMountPointAt, libs, "g_unix_mount_point_at")
	core.PuregoSafeRegister(&xUnixMountPointsChangedSince, libs, "g_unix_mount_points_changed_since")
	core.PuregoSafeRegister(&xUnixMountPointsGet, libs, "g_unix_mount_points_get")
	core.PuregoSafeRegister(&xUnixMountPointsGetFromFile, libs, "g_unix_mount_points_get_from_file")
	core.PuregoSafeRegister(&xUnixMountsChangedSince, libs, "g_unix_mounts_changed_since")
	core.PuregoSafeRegister(&xUnixMountsGet, libs, "g_unix_mounts_get")
	core.PuregoSafeRegister(&xUnixMountsGetFromFile, libs, "g_unix_mounts_get_from_file")

	core.PuregoSafeRegister(&xUnixMountEntryGLibType, libs, "g_unix_mount_entry_get_type")

	core.PuregoSafeRegister(&xUnixMountEntryCompare, libs, "g_unix_mount_entry_compare")
	core.PuregoSafeRegister(&xUnixMountEntryCopy, libs, "g_unix_mount_entry_copy")
	core.PuregoSafeRegister(&xUnixMountEntryFree, libs, "g_unix_mount_entry_free")
	core.PuregoSafeRegister(&xUnixMountEntryGetDevicePath, libs, "g_unix_mount_entry_get_device_path")
	core.PuregoSafeRegister(&xUnixMountEntryGetFsType, libs, "g_unix_mount_entry_get_fs_type")
	core.PuregoSafeRegister(&xUnixMountEntryGetMountPath, libs, "g_unix_mount_entry_get_mount_path")
	core.PuregoSafeRegister(&xUnixMountEntryGetOptions, libs, "g_unix_mount_entry_get_options")
	core.PuregoSafeRegister(&xUnixMountEntryGetRootPath, libs, "g_unix_mount_entry_get_root_path")
	core.PuregoSafeRegister(&xUnixMountEntryGuessCanEject, libs, "g_unix_mount_entry_guess_can_eject")
	core.PuregoSafeRegister(&xUnixMountEntryGuessIcon, libs, "g_unix_mount_entry_guess_icon")
	core.PuregoSafeRegister(&xUnixMountEntryGuessName, libs, "g_unix_mount_entry_guess_name")
	core.PuregoSafeRegister(&xUnixMountEntryGuessShouldDisplay, libs, "g_unix_mount_entry_guess_should_display")
	core.PuregoSafeRegister(&xUnixMountEntryGuessSymbolicIcon, libs, "g_unix_mount_entry_guess_symbolic_icon")
	core.PuregoSafeRegister(&xUnixMountEntryIsReadonly, libs, "g_unix_mount_entry_is_readonly")
	core.PuregoSafeRegister(&xUnixMountEntryIsSystemInternal, libs, "g_unix_mount_entry_is_system_internal")

	core.PuregoSafeRegister(&xUnixMountPointGLibType, libs, "g_unix_mount_point_get_type")

	core.PuregoSafeRegister(&xUnixMountPointCompare, libs, "g_unix_mount_point_compare")
	core.PuregoSafeRegister(&xUnixMountPointCopy, libs, "g_unix_mount_point_copy")
	core.PuregoSafeRegister(&xUnixMountPointFree, libs, "g_unix_mount_point_free")
	core.PuregoSafeRegister(&xUnixMountPointGetDevicePath, libs, "g_unix_mount_point_get_device_path")
	core.PuregoSafeRegister(&xUnixMountPointGetFsType, libs, "g_unix_mount_point_get_fs_type")
	core.PuregoSafeRegister(&xUnixMountPointGetMountPath, libs, "g_unix_mount_point_get_mount_path")
	core.PuregoSafeRegister(&xUnixMountPointGetOptions, libs, "g_unix_mount_point_get_options")
	core.PuregoSafeRegister(&xUnixMountPointGuessCanEject, libs, "g_unix_mount_point_guess_can_eject")
	core.PuregoSafeRegister(&xUnixMountPointGuessIcon, libs, "g_unix_mount_point_guess_icon")
	core.PuregoSafeRegister(&xUnixMountPointGuessName, libs, "g_unix_mount_point_guess_name")
	core.PuregoSafeRegister(&xUnixMountPointGuessSymbolicIcon, libs, "g_unix_mount_point_guess_symbolic_icon")
	core.PuregoSafeRegister(&xUnixMountPointIsLoopback, libs, "g_unix_mount_point_is_loopback")
	core.PuregoSafeRegister(&xUnixMountPointIsReadonly, libs, "g_unix_mount_point_is_readonly")
	core.PuregoSafeRegister(&xUnixMountPointIsUserMountable, libs, "g_unix_mount_point_is_user_mountable")

	core.PuregoSafeRegister(&xUnixMountMonitorGLibType, libs, "g_unix_mount_monitor_get_type")

	core.PuregoSafeRegister(&xNewUnixMountMonitor, libs, "g_unix_mount_monitor_new")

	core.PuregoSafeRegister(&xUnixMountMonitorSetRateLimit, libs, "g_unix_mount_monitor_set_rate_limit")

	core.PuregoSafeRegister(&xUnixMountMonitorGet, libs, "g_unix_mount_monitor_get")
